...
- 他人下载并解压你的文件夹到**global/Assets**并在**gamelist.json**中添加**bv**号信息即可游玩（后续会简化此步骤）
---
# 参与项目开发
...
~~没错如你所见，还有这么多问题没有解决，甚至连代码项目结构都不好好组织就放出来，因为并不经常写前端加上最近真的太忙了就开摆了，所以尽量不要骂我()~~